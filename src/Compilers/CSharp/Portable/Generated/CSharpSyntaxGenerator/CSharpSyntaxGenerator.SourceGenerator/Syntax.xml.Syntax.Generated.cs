...
namespace Microsoft.CodeAnalysis.CSharp.Syntax
{
    ...
    public sealed partial class YieldStatementSyntax : StatementSyntax
    {
        ...
        public SyntaxToken SemicolonToken => new SyntaxToken(this, ((Syntax.InternalSyntax.YieldStatementSyntax)this.Green).semicolonToken, GetChildPosition(5), GetChildIndex(5));
        ...
        public YieldStatementSyntax Update(SyntaxList<AttributeListSyntax> attributeLists, SyntaxToken yieldKeyword, SyntaxToken returnOrBreakKeyword, SyntaxToken questionToken, ExpressionSyntax? expression, SyntaxToken semicolonToken)
        {
        ...
        internal override StatementSyntax WithAttributeListsCore(SyntaxList<AttributeListSyntax> attributeLists) => WithAttributeLists(attributeLists);
        public new YieldStatementSyntax WithAttributeLists(SyntaxList<AttributeListSyntax> attributeLists) => Update(attributeLists, this.YieldKeyword, this.ReturnOrBreakKeyword, this.QuestionToken, this.Expression, this.SemicolonToken);
        public YieldStatementSyntax WithYieldKeyword(SyntaxToken yieldKeyword) => Update(this.AttributeLists, yieldKeyword, this.ReturnOrBreakKeyword, this.QuestionToken, this.Expression, this.SemicolonToken);
        public YieldStatementSyntax WithReturnOrBreakKeyword(SyntaxToken returnOrBreakKeyword) => Update(this.AttributeLists, this.YieldKeyword, returnOrBreakKeyword, this.QuestionToken, this.Expression, this.SemicolonToken);
        public YieldStatementSyntax WithQuestionToken(SyntaxToken questionToken) => Update(this.AttributeLists, this.YieldKeyword, this.ReturnOrBreakKeyword, questionToken, this.Expression, this.SemicolonToken);
        public YieldStatementSyntax WithExpression(ExpressionSyntax? expression) => Update(this.AttributeLists, this.YieldKeyword, this.ReturnOrBreakKeyword, this.QuestionToken, expression, this.SemicolonToken);
        public YieldStatementSyntax WithSemicolonToken(SyntaxToken semicolonToken) => Update(this.AttributeLists, this.YieldKeyword, this.ReturnOrBreakKeyword, this.QuestionToken, this.Expression, semicolonToken);
